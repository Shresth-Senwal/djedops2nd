...
export function calculateReserveRatio(
  ...
  if (sigUsdCirculation <= 0) {
    // This is normal if using simulated data or network has low activity
    console.info('ℹ️ Circulation is 0 (using Ergo blockchain metrics), returning 0% reserve ratio');
    return 0;
  }
